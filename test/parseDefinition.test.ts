...
const definitions: ComposerConfigOptions<TestProps> = {
  ...
  simpleDeepArr: [
    "css1",
    ["css22", ["css23", "css233", "css2333"], "css24"],
    "css3",
  ],
  ...
  obj: {
    ...
    medium: ["css-size-medium-1", "css-size-medium-2", "css-size-medium-3"],
    large: [
      "some-css",
      { dark: "dark-css" },
...
describe("parseDefinition()", () => {
  ...
  it("should return classes if defined as a array option", () => {
    ...
    expect(result.join(" ")).toBe(
      "css-size-medium-1 css-size-medium-2 css-size-medium-3"
    );
  });
  ...
  it("should parse if option has pseudo definitions", () => {
    ...
    expect(result.join(" ")).toBe(
      "some-css dark:dark-css dark:another-dark-css hover:hover-css"
    );
  });
  ...
  it("should parse deep recursive definitions", () => {
    ...
    expect(result.join(" ")).toBe(
      "a b c d mix:e mix:another:f mix:g mix:j mix:k deep:l deep:m deep:n mix:deep:O mix:deep:P mix:deep:Q"
    );
  });
